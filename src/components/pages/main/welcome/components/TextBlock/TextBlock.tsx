...
import WelcomeSchema from "@/models/pages/main/sections/welcome/schema";
...
export default function TextBlock({data}: Props){
  ...
  return(
    <div className={`${styles.container}`}>
      <h3 className="text-xl font-bold text-content-accent ml-1.5">{data.suptitle}</h3>
      <h2 className={`font-bold uppercase text-content-neutral ${styles.title}`}>{data.title}</h2>
      <h4 className="text-content-base ml-1.5 mt-10">{data.lead}</h4>
