...
export const actionCallProductData = (payload: ProductGetRecursiveDto) => ({type: PRODUCT_DATA_CALL, payload})
export const actionCallGlobalData = (payload: GlobalDataType) => ({type: GLOBAL_DATA_CALL, payload})
/*************************************************************************************************** */
export const actionSaveProductData = (payload: ProductGetRecursiveDto) => ({type: PRODUCT_DATA_SAVE, payload})
